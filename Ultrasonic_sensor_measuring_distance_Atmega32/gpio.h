...
/*
 * Description:
 * Read and return the value of the required pin, it should be Logic High or Low
 * If  the input port number or pin is not correct, The function will not handle this request.
 */
